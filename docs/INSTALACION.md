...
Después, carga esas variables en la sesión:
...
### Paso 6 — Comprobar que el bot ve tu cuenta

Con MT5 **abierto y con sesión iniciada**:
...
### Paso 8 — Revisar lo que encontró

```powershell
goldbot strategies              # lista todo
goldbot report champion         # informe con las 5 pruebas
...
Un proceso independiente por instrumento, con su propia configuración:
...
desplázate hacia atrás con la rueda del ratón. Luego repite `goldbot data --update`.
